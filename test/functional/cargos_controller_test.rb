...
class CargosControllerTest < ActionController::TestCase
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post :create, cargo: { alumno_id: @cargo.alumno_id, fecha: @cargo.fecha, tipo_cargo_id: @cargo.tipo_cargo_id }
    end
  ...
  test "should update cargo" do
    put :update, id: @cargo, cargo: { alumno_id: @cargo.alumno_id, fecha: @cargo.fecha, tipo_cargo_id: @cargo.tipo_cargo_id }
    assert_redirected_to cargo_path(assigns(:cargo))
  end
